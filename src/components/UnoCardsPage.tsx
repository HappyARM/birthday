...
import Music1 from '../music/Stay.mp3';
import Music2 from '../music/Tora ee hasa.mp3'
import Music3 from '../music/Paroo.mp3';
import Music4 from '../music/HER.mp3';
  ...
  const cards: UnoCardData[] = [
    {
      ...
      number: "1",
      photoUrl: Img1,
      caption: "This is me, with you and long hugs session.",
      musicName: "I need you to STAY",
      musicUrl: Music1,
    },
    {
      color: "bg-blue-500",
      number: "2",
      photoUrl: Img2,
      caption: "This is you when you smile. This smile makes my whole day. Muaahhh",
      musicName: "Toro ee hasa re aji",
      musicUrl: Music2,
    },
    {
      color: "bg-green-500",
      number: "3",
      photoUrl: Img3,
      caption: "This is how the kid in u looks, when you feel comfortable around me  ",
      musicName: "Paroo",
      musicUrl: Music3,
    },
    {
      ...
      number: "4",
      photoUrl: Img4,
      caption: "This is how you look, cute n divine❤️.",
      musicName: "Her",
      musicUrl: Music4,
    },
    ...
    >
      ...
      {flipped.every((isFlipped) => isFlipped) && (
        <div className="text-center transition-all duration-500">
          ...
          >
            Well, I have written something for you Bebo<ChevronRight className="ml-2" />
          </button>
        </div>
      )}
    </div>
