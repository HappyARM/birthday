...
import bgMusic from './music/KTMBK.mp3';
...
const InitialCard: React.FC<{ onNext: () => void }> = ({ onNext }) => {
  const messages = [
    "Happy Birthday Shneha!",
    "I know you like UNO, And It's Your Special Day!",
    "So..........!",
    "I wanted to make something special for you with UNO style and here it is"
  ];
      ...
      <div className="bg-blue-600 rounded-3xl shadow-2xl p-8 transform transition-all duration-500 hover:scale-105 max-w-md mx-auto">
        ...
        <div className="bg-white/20 backdrop-blur-sm rounded-xl p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-white font-bold text-xl">Kahoon toh mein bhi kya?</h3>
              <p className="text-white/80">KTMBK</p>
            </div>
            <button 
              onClick={togglePlay}
